def get_country_bounding_boxes(country_name):
    return country_bounding_boxes[country_name]
...
def get_ISO3166_citycode(city_name):
    city_code = ""
    try:
        city_code = ISO_3166_2_IT_CITY_SOUNDEX[soundex(city_name)]
    except:
        '''
            简单进行字符串匹配
        '''
        city_code = None
        for key in ISO_3166_2_IT_CITY.keys():
            if key in city_name:
                city_code = ISO_3166_2_IT_CITY[key]
        return city_code

    return city_code


ISO_3166_2_IT_CITY_SOUNDEX = {
    soundex("Agrigento"): "AG",
    soundex("Alessandria"): "AL",
    soundex("Ancona"): "AN",
    soundex("Ascoli Piceno"): "AP",
    soundex("L'Aquila"): "AQ",
    soundex("Arezzo"): "AR",
    soundex("Asti"): "AT",
    soundex("Avellino"): "AV",
    ...
    soundex("Biella"): "BI",
    soundex("Belluno"): "BL",
    soundex("Benevento"): "BN",
    soundex("Bologna"): "BO",
    soundex("Brindisi"): "BR",
    soundex("Brescia"): "BS",
    soundex("Barletta-Andria-Trani"): "BT",
    soundex("Bolzano / Bozen (de)"): "BZ",
    soundex("Cagliari"): "CA",
    soundex("Campobasso"): "CB",
    soundex("Caserta"): "CE",
    soundex("Chieti"): "CH",
    soundex("Caltanissetta"): "CL",
    soundex("Cuneo"): "CN",
    soundex("Como"): "CO",
    soundex("Cremona"): "CR",
    soundex("Cosenza"): "CS",
    soundex("Catania"): "CT",
    soundex("Catanzaro"): "CZ",
    soundex("Enna"): "EN",
    soundex("ForlÏ-Cesena"): "FC",
    soundex("Ferrara"): "FE",
    soundex("Foggia"): "FG",
    soundex("Firenze"): "FI",
    soundex("Fermo"): "FM",
    soundex("Frosinone"): "FR",
    soundex("Genova"): "GE",
    soundex("Grosseto"): "GR",
    soundex("Imperia"): "IM",
    soundex("Isernia"): "IS",
    ...
    soundex("Latina"): "LT",
    soundex("Lucca"): "LU",
    soundex("Monza e Brianza"): "MB",
    soundex("Macerata"): "MC",
    soundex("Messina"): "ME",
    soundex("Milano"): "MI",
    soundex("Mantova"): "MN",
    soundex("Modena"): "MO",
    soundex("Massa-Carrara"): "MS",
    soundex("Matera"): "MT",
    soundex("Napoli"): "NA",
    soundex("Novara"): "NO",
    soundex("Nuoro"): "NU",
    ...
    soundex("Parma"): "PR",
    soundex("Pistoia"): "PT",
    soundex("Pesaro e Urbino"): "PU",
    soundex("Pavia"): "PV",
    soundex("Potenza"): "PZ",
    soundex("Ravenna"): "RA",
    soundex("Reggio Calabria"): "RC",
    soundex("Reggio Emilia"): "RE",
    soundex("Ragusa"): "RG",
    soundex("Rieti"): "RI",
    soundex("Roma"): "RM",
    soundex("Rimini"): "RN",
    soundex("Rovigo"): "RO",
    soundex("Salerno"): "SA",
    soundex("Sud Sardegna"): "SD",
    soundex("Siena"): "SI",
    soundex("Sondrio"): "SO",
    soundex("La Spezia"): "SP",
    soundex("Siracusa"): "SR",
    soundex("Sassari"): "SS",
    soundex("Savona"): "SV",
    soundex("Taranto"): "TA",
    ...
    soundex("Treviso"): "TV",
    soundex("Varese"): "VA",
    soundex("Verbano-Cusio-Ossola"): "VB",
    soundex("Vercelli"): "VC",
    soundex("Venezia"): "VE",
    soundex("Vicenza"): "VI",
    soundex("Verona"): "VR",
    soundex("Viterbo"): "VT",
    soundex("Vibo Valentia"): "VV"
}
